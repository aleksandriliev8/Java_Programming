...
public class Controller {
    ...
    void btnListOnAction(ActionEvent event) {
        candidates = new Staff[]{
                new Staff("Staff 1", random.nextInt(3000 * 100, (5000 * 100) + 1) / 100.0,
                        "Candidate"),
                new Staff("Staff 2", random.nextInt(3000 * 100, (5000 * 100) + 1) / 100.0,
                        "Candidate")
        };
    ...
    void initialize() {
        ...
        hRdepartment.getManager().addAppointHandler(sah);
    }
